(function (prosemirrorSchemaBasic, prosemirrorModel, prosemirrorCommands, prosemirrorHistory, prosemirrorKeymap, prosemirrorState, prosemirrorView, prosemirrorExampleSetup) {
	...
	var CodeBlockView = function CodeBlockView(node, view, getPos) {
	  ...
	  setTimeout(function () { return this$1$1.cm.refresh(); }, 20);
	  // 这个标记用来避免在外部编辑器和内部编辑器之间的循环更新
	  this.updating = false;
	  // 追踪是否改变已经发生，但是还没有传递出去
	  this.cm.on("beforeChange", function () { return this$1$1.incomingChanges = true; });
	  // 将代码编辑器的更新传递给外层的 ProseMirror
	  this.cm.on("cursorActivity", function () {
	    if (!this$1$1.updating && !this$1$1.incomingChanges) { this$1$1.forwardSelection(); }
	  });
	  this.cm.on("changes", function () {
	    if (!this$1$1.updating) {
	      this$1$1.valueChanged();
	      this$1$1.forwardSelection();
	    }
	    this$1$1.incomingChanges = false;
	  });
	  this.cm.on("focus", function () { return this$1$1.forwardSelection(); });
	};
	// }
	...
	CodeBlockView.prototype.codeMirrorKeymap = function codeMirrorKeymap () {
	  ...
	  return codemirror.normalizeKeyMap(( obj = {
	    Up: function () { return this$1$1.maybeEscape("line", -1); },
	    Left: function () { return this$1$1.maybeEscape("char", -1); },
	    Down: function () { return this$1$1.maybeEscape("line", 1); },
	    Right: function () { return this$1$1.maybeEscape("char", 1); },
	    "Ctrl-Enter": function () {
